import {
  to = segment_reverse_etl_model.id-c9D3sZx8Q39njS83wTcrke
  id = "c9D3sZx8Q39njS83wTcrke"
}

resource "segment_reverse_etl_model" "id-c9D3sZx8Q39njS83wTcrke" {
  description             = "reviews"
  enabled                 = false
  name                    = "Reviews via DBT"
