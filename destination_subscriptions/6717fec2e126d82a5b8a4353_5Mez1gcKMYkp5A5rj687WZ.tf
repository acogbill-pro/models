...
resource "segment_destination_subscription" "id-6717fec2e126d82a5b8a4353_5Mez1gcKMYkp5A5rj687WZ" {
  ...
  settings = jsonencode({
    anonymous_id = {
      "@path" = "$.properties.anonymous_id_c"
    }
    consent = {
      "@path" = "$.context.consent"
    }
    engage_space = "x2zPLJyKwsPESrDJLQiAGAlIWYH5IYlk"
    message_id = {
      "@path" = "$.messageId"
    }
    timestamp = {
    ...
    traits = {
      ...
      dwh_validated = {
        "@path" = "$.properties.dwh_validated_c"
      }
      first_name = {
        "@path" = "$.properties.first_name"
      }
      follow_up = {
        "@path" = "$.properties.follow_up_c"
      }
      last_name = {
