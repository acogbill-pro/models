...
resource "segment_destination_subscription" "id-6648883872e824ad8803c1a9_6rXaaJb7heNyfJWEvFCMFj" {
  ...
  settings       = "{\"anonymous_id\":{\"@path\":\"$.properties.ANONYMOUS_ID\"},\"consent\":{\"@path\":\"$.context.consent\"},\"event_name\":\"Product Review\",\"message_id\":{\"@path\":\"$.messageId\"},\"properties\":{\"@path\":\"$.properties\"},\"timestamp\":{\"@path\":\"$.receivedAt\"},\"user_id\":{\"@path\":\"$.properties.USER_ID\"}}"
  trigger        = "event = \"new\""
}