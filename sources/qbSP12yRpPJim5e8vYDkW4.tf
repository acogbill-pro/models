...
resource "segment_source" "id-qbSP12yRpPJim5e8vYDkW4" {
  ...
  settings = jsonencode({
    createdAt              = "2024-10-22T19:31:49.191Z"
    createdBy              = "andy.cogbill@segment.com"
    displayName            = "andy.cogbill@segment.com"
    instance-url           = "https://twilio124-dev-ed.develop.my.salesforce.com"
